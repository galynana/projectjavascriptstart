...
function writeYourGenres() {
    for (let i = 1; i<=3; i++) {
        ...
        personalMovieDB.genres[i-1] = genre; /* чтобы начать с 0 */ /* для пользователя i=1 */
        /* personalMovieDB.genres[i-1] = prompt(`Ваш любимый жанр под номером ${i}`);  так тоже можно записать*/
     }
} 
